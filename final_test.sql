...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2024 at 11:19 AM
...
--
ALTER TABLE `administrativesupport`
  ADD CONSTRAINT `administrativesupport_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `employeerelation` (`Eid`) ON DELETE CASCADE;

--
-- Constraints for table `airportairline`
--
ALTER TABLE `airportairline`
  ADD CONSTRAINT `airportairline_ibfk_1` FOREIGN KEY (`APname`) REFERENCES `airportrelation` (`APname`) ON DELETE CASCADE,
  ADD CONSTRAINT `airportairline_ibfk_2` FOREIGN KEY (`AirlineID`) REFERENCES `airlinerelation` (`AirlineID`) ON DELETE CASCADE;

--
-- Constraints for table `airportauthority`
--
ALTER TABLE `airportauthority`
  ADD CONSTRAINT `airportauthority_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `employeerelation` (`Eid`) ON DELETE CASCADE;

--
-- Constraints for table `airportcountry`
--
ALTER TABLE `airportcountry`
  ADD CONSTRAINT `airportcountry_ibfk_1` FOREIGN KEY (`Cname`) REFERENCES `citycountry` (`Cname`) ON DELETE CASCADE;

--
-- Constraints for table `citycountry`
--
ALTER TABLE `citycountry`
  ADD CONSTRAINT `citycountry_ibfk_1` FOREIGN KEY (`Cname`) REFERENCES `citystate` (`Cname`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `employeepno`
--
ALTER TABLE `employeepno`
  ADD CONSTRAINT `employeepno_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `employeerelation` (`Eid`) ON DELETE CASCADE;

--
-- Constraints for table `employeerelation`
--
ALTER TABLE `employeerelation`
  ADD CONSTRAINT `employeerelation_ibfk_1` FOREIGN KEY (`Said`) REFERENCES `salaryjob` (`Said`) ON DELETE CASCADE;

--
-- Constraints for table `employerpassenger`
--
ALTER TABLE `employerpassenger`
  ADD CONSTRAINT `employerpassenger_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `employeerelation` (`Eid`) ON DELETE CASCADE;

--
-- Constraints for table `engineer`
--
ALTER TABLE `engineer`
  ADD CONSTRAINT `engineer_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `employeerelation` (`Eid`) ON DELETE CASCADE;

--
-- Constraints for table `flightconnecting`
--
ALTER TABLE `flightconnecting`
  ADD CONSTRAINT `flightconnecting_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `passengerrelation` (`PID`) ON DELETE CASCADE;

--
-- Constraints for table `flightrelation`
--
ALTER TABLE `flightrelation`
  ADD CONSTRAINT `flightrelation_ibfk_1` FOREIGN KEY (`AirlineID`) REFERENCES `airlinerelation` (`AirlineID`) ON DELETE CASCADE;

--
-- Constraints for table `passengerpassport`
--
ALTER TABLE `passengerpassport`
  ADD CONSTRAINT `passengerpassport_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `passengerrelation` (`PID`) ON DELETE CASCADE;

--
-- Constraints for table `passengerpno`
--
ALTER TABLE `passengerpno`
  ADD CONSTRAINT `passengerpno_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `passengerrelation` (`PID`) ON DELETE CASCADE;

--
-- Constraints for table `passengerrelation`
--
ALTER TABLE `passengerrelation`
  ADD CONSTRAINT `passengerrelation_ibfk_1` FOREIGN KEY (`FlightCode`) REFERENCES `flightrelation` (`FlightCode`) ON DELETE CASCADE;

--
-- Constraints for table `ticketrelation`
--
ALTER TABLE `ticketrelation`
  ADD CONSTRAINT `ticketrelation_ibfk_1` FOREIGN KEY (`PID`) REFERENCES `passengerrelation` (`PID`) ON DELETE CASCADE,
  ADD CONSTRAINT `ticketrelation_ibfk_2` FOREIGN KEY (`PCID`) REFERENCES `passengerclass` (`PCID`) ON DELETE CASCADE;

--
-- Constraints for table `trafficmonitor`
--
ALTER TABLE `trafficmonitor`
  ADD CONSTRAINT `trafficmonitor_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `employeerelation` (`Eid`) ON DELETE CASCADE;
COMMIT;
